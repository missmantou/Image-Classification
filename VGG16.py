# -*- coding: utf-8 -*-
"""
Created on Thu Feb 17 09:19:16 2022
...
Image.MAX_IMAGE_PIXCELS = 211680000 # this is to avoid the error message
...
history = finetune_model.fit_generator(train_generator, epochs = NUM_EPOCHS, workers = 8
                                       steps_per_epochs = num_train_images // BATCH_SIZE,
...
mypath = "H:\\WIP\\Image_Classification\\scripts\\test\\form"
src_path = [join(mypath, f) for f in listdir(mypath) if isfile(join(mypath,f))]
